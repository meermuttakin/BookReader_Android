...
public class ClickToNext extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_click_to_next);
...
//                            loadinter();
                            ...
                            nextbut.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    Intent intent7 = new Intent(ClickToNext.this,TaskFour.class);
